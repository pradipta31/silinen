<?php
    ...
    try {
        // Ambil data pencucian termasuk jumlah dan id_linen_ruangan
        $query_get = mysqli_query($koneksi, "SELECT jumlah, id_linen_ruangan FROM pencucian WHERE id = '$id'");
        ...
        if ($data) {
            ...
            // Update status pencucian ke 2
            $query_update_status = mysqli_query($koneksi, "UPDATE pencucian SET status = 2 WHERE id = '$id'");
