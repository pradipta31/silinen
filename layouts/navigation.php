<aside class="main-sidebar">
    ...
    <section class="sidebar">
            ...
            <li>
                <a href="#">
                    <i class="fa fa-hospital-o"></i> <span>Ruang <?php
                        ...
                        echo $ruangan ? htmlspecialchars($ruangan['nama_ruangan']) : 'Belum diatur';
                    ?></span>
                </a>
            </li>
        </ul>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?= $_SESSION['active_menu'] == 'linen' ? 'active' : '' ?>">
                <a href="../petugas_laundry/data_linen.php">
                    <i class="fa fa-bed"></i> <span>Data Linen</span>
                </a>
            </li>
            <li class="<?= $_SESSION['active_menu'] == 'linen_ruangan' ? 'active' : '' ?>">
                <a href="../petugas_laundry/linen_ruangan.php">
                    <i class="fa fa-bed"></i> <span>Linen Ruangan</span>
                </a>
            </li>
            ...
            <li class="treeview <?= $_SESSION['active_menu'] == 'laporan' ? 'active' : '' ?>">
                ...
                <ul class="treeview-menu">
                    <li><a href="../petugas_laundry/data_laporan_pengajuan.php"><i class="fa fa-file-text-o"></i> Laporan Pengajuan Linen</a></li>
                    <li><a href="../petugas_laundry/data_laporan_pencucian.php"><i class="fa fa-file-text-o"></i> Laporan Pencucian Linen</a></li>
                </ul>
            </li>
        </ul>
