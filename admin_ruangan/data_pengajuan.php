            ...
            <div class="box">
                <div class="box-header">
                    <div class="form-group">
                        <a href="tambah_pengajuan.php" class="btn btn-primary"><i class="fa fa-paper-plane"></i> Buat Pengajuan</a>
                    </div>
                    <h3 class="box-title">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?= ($data['status'] == 1) ? '<span class="label label-warning"><i class="fa fa-clock-o"></i> Pengajuan</span>' : 
                                            (($data['status'] == 2) ? '<span class="label label-primary"><i class="fa fa-truck"></i> Pengiriman</span>' : 
                                            (($data['status'] == 3) ? '<span class="label label-success"><i class="fa fa-check-circle"></i> Diterima</span>' : 
