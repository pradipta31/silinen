...
$id_user = $row['id'];
$queryRuangan = mysqli_query($koneksi, "SELECT * FROM ruangan WHERE id_user = '$id_user'");
            ...
            <div class="box">
                <div class="box-header">
                    <div class="form-group">
                        <a href="tambah_pencucian.php" class="btn btn-primary"><i class="fa fa-tint"></i> Permohonan Pencucian</a>
                    </div>
                    <h3 class="box-title">
                        <i class="fa fa-list"></i> Daftar Pencucian
                    </h3>
                </div>
                <div class="box-body">
