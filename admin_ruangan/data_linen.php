                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-xs btn-success" onclick="showPengajuanModal(<?= $data['id'] ?>, '<?= $data['kode_linen'] ?>', '<?= addslashes($data['nama_linen']) ?>', <?= $data['sisa_linen'] ?>)" data-toggle="modal" data-target="#modalPengajuan">
                                        ...
                                        <!-- Modal Pengajuan Linen -->
                                        <div class="modal fade" id="modalPengajuan" tabindex="-1" role="dialog" aria-labelledby="modalPengajuanLabel">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="modalPengajuanLabel">
                                                            <i class="fa fa-paper-plane"></i> Form Pengajuan Linen
                                                        </h4>
                                                    </div>

                                                    <form action="proses_pengajuan.php" method="POST">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="id_linen" id="id_linen" value="">
                                                            <input type="hidden" name="id_user" value="<?= $row['id'] ?>">

                                                            <div class="form-group">
                                                                <label for="kode_linen">Kode Linen</label>
                                                                <input type="text" class="form-control" id="kode_linen" name="kode_linen" value="<?= $data['kode_linen'] ?>" readonly>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="nama_linen">Nama Linen</label>
                                                                <input type="text" class="form-control" id="nama_linen" name="nama_linen" value="<?= $data['nama_linen'] ?>" readonly>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="jumlah">Jumlah Pengajuan <span class="text-danger">*</span></label>
