...
$dataQuery = mysqli_query($koneksi, "SELECT p.*, l.nama_linen as nama_linen, r.nama_ruangan as nama_ruangan
                                    FROM pengajuan p
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-list"></i> Daftar Pengajuan</h3>
                </div>
                <div class="box-body">
                                ...
                                <?php $no = 1; while ($data = mysqli_fetch_assoc($dataQuery)): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php
                                                if ($data['status'] == 1) {
                                                    echo '<span class="label label-warning"><i class="fa fa-clock-o"></i> Pengajuan</span>';
                                                } elseif ($data['status'] == 2) {
                                                    echo '<span class="label label-primary"><i class="fa fa-truck"></i> Pengiriman</span>';
                                                } elseif ($data['status'] == 3) {
                                                    echo '<span class="label label-success"><i class="fa fa-check-circle"></i> Diterima</span>';
                                                } else {
                    ...
                    <?php else: ?>
                        <div class="alert alert-info text-center">
                            <i class="fa fa-info-circle"></i> Tidak ada data pengajuan.
                        </div>
                    <?php endif; ?>
                </div>
            </div>
